...
namespace Masa.Mc.EntityFrameworkCore.PostgreSql.Migrations
{
    ...
    [Migration("20260918014727_AddMessageRecordContentSnapshot")]
    partial class AddMessageRecordContentSnapshot
    {
            ...
            modelBuilder.Entity("Masa.Mc.Domain.MessageRecords.Aggregates.MessageRecord", b =>
                {
                    ...
                    b.HasIndex("MessageTaskHistoryId", "Success");
            ...
            modelBuilder.Entity("Masa.Mc.Domain.MessageRecords.Aggregates.MessageRecord", b =>
                {
                    ...
                    b.OwnsOne("Masa.Mc.Domain.MessageInfos.Aggregates.MessageContent", "ContentSnapshot", b1 =>
                        {
                            ...
                            b1.ToTable("MessageRecordContents", (string)null);
