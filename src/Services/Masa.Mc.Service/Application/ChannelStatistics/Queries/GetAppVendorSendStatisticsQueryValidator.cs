...
public class GetAppVendorSendStatisticsQueryValidator : AbstractValidator<GetAppVendorSendStatisticsQuery>
{
    public GetAppVendorSendStatisticsQueryValidator() =>
