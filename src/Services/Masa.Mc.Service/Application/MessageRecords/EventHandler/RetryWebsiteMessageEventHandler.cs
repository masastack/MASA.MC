...
public class RetryWebsiteMessageEventHandler
{
    ...
    public async Task HandleEventAsync(RetryWebsiteMessageEvent eto)
    {
        ...
        var websiteMessage = new WebsiteMessage(messageRecord.MessageTaskHistoryId, messageRecord.ChannelId, messageRecord.UserId, messageData.MessageContent.Title, messageData.MessageContent.Content, messageData.MessageContent.GetJumpUrl(), DateTimeOffset.UtcNow, messageData.MessageContent.ExtraProperties);
