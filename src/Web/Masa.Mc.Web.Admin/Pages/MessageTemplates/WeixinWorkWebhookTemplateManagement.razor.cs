...
public partial class WeixinWorkWebhookTemplateManagement : AdminCompontentBase
{
    [Inject]
    public I18n I18n { get; set; }

    private WeixinWorkWebhookUpsertModal _upsertModal = default!;
    private GetMessageTemplateInputDto _queryParam = new() { ChannelType = ChannelTypes.WeixinWorkWebhook };
    ...
    {
        _channelItems = await ChannelService.GetListByTypeAsync(ChannelTypes.WeixinWorkWebhook);
