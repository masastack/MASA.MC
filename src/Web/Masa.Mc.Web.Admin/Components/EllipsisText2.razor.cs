...
public partial class EllipsisText2 : IAsyncDisposable
{
    ...
    private DotNetObjectReference<EllipsisText2>? _selfReference;
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        if (firstRender)
        {
            ...
            _jsModule = await Js.InvokeAsync<IJSObjectReference>("import", "./_content/Masa.Mc.Web.Admin/Components/EllipsisText2.razor.js");
