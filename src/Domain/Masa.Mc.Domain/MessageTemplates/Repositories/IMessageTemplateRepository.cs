...
namespace Masa.Mc.Domain.MessageTemplates.Repositories;
...
public interface IMessageTemplateRepository : IRepository<MessageTemplate>
{
    ...
    Task<MessageTemplate?> FindNoTrackingAsync(Expression<Func<MessageTemplate, bool>> predicate, bool include = true, CancellationToken cancellationToken = default(CancellationToken));
